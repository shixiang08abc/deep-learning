...
if __name__=="__main__":
  ...
  tf_ckpt = '/data/shixiang/termweight/qanchor_tag_train/models/lstmp_tw_refine_199'
  reader = tf.train.NewCheckpointReader(tf_ckpt)

  #cell_size proj_num word_embedding tag_embedding target_num
  wfin.write(str(256) + " " + str(128) + " " + str(100) + " " + str(10) + " " + str(3) + "\n")
