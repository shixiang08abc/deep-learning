...
// =====================================================================
#ifndef LSTM_CRF_DECODE_H
#define LSTM_CRF_DECODE_H
...
class LstmTwDecode
{
	public:
		...
		void getTermWeight(std::vector<std::string>& words, std::vector<size_t>& tags);
		...
		void PropagateCrf(const float* mat_fw_output, const float* mat_bw_output, size_t output_row, size_t output_col, std::vector<size_t>& tags);
